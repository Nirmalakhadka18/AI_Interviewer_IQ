...
const navigate = useNavigate()
 ...
 const downloadPDF = () => {
  ...
  doc.text(
    `Final Score: ${finalScore}/10`,pageWidth / 2,currentY + 12,
    {
      align: "center",
    }
  );
  ...
  doc.roundedRect(margin,currentY,contentWidth,35,4,4,"S");
...
<div className="min-h-screen bg-gradient-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
        ...
        <div className="md:mb-10 w-full flex items-start gap-4 flex-wrap">
          ...
          <div>
            <h1
              className="text-3xl font-bold flex-nowrap
                          text-gray-800"
            >
     ...
     <button onClick={downloadPDF} className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-xl shadow-md 
     transition-all duration-300 font-semibold text-sm sm:text-base text-nowrap">
  Download PDF
</button>
      </div>
        ...
        >
          ...
          >
            <div>
              ...
              <p
                className="font-semibold text-gray-800 text-sm sm:text-base leading-relaxed"
              >
                {q.question || "Question not available"}
              </p>
            </div>
            ...
            <div
              className="bg-green-100 text-green-600 px-3 py-1 rounded-full font-bold text-xs sm:text-sm w-fit"
            >
              {q.score ?? 0}/10
            </div>
          </div>
