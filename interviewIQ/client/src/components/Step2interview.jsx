...
import { FaMicrophone, FaMicrophoneAltSlash, FaMicrophoneSlash } from 'react-icons/fa';
...
useEffect(() => {
    ...
    recognition.isStarting = false;
    
recognition.onstart = () => {
    recognition.isStarting = true;
        ...
        setTimeout(() => {
            if (
               ...
               startMic();
                    ...
                    console.log("Mic restart blocked:", err);
                }
            }
        }, 800);
    }
...
const startMic = () => {
    if (!recognitionRef.current || !isMicOnRef.current || isAIPlayingRef.current) return;

    if (recognitionRef.current.isStarting) return;
    ...
    setTimeout(() => {
        if (recognitionRef.current) {
            recognitionRef.current.isStarting = false;
        }
    }, 1500);
};
...
const toggleMic = async () => {
    if (isMicOn) {
        ...
        try {
            ...
            setTimeout(() => {
                startMic();
                console.log("Mic manually activated");
            }, 500);
    ...
    return (
        ...
        to-teal-100 flex items-center justify-center p-4 sm:p-6'>
            ...
            border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
              ...
              {/* subtitle */}
      {subtitle && (
    <div className='w-full max-w-md bg-gray-50 border border-gray-200 rounded-3xl p-4 shadow-sm'>
...
<div className='space-y-6'>
    ...
    <div className='grid grid-cols-2 gap-6 text-center'>
        ...
        <div>
         ...
         {/* Text Section */}
                <div className='flex-1 flex flex-col bg-white p-6 sm:p-8 md:p-10'>

                    <h2 className='text-xl sm:text-2xl font-bold text-emerald-600 mb-6 text-center'>
                        AI Smart Interview
                    </h2>

                   {!isIntroPhase && <div className='bg-gray-50 p-6 rounded-2xl border border-gray-200 shadow-sm mb-6'>
    ...
    className='flex-1 bg-gray-100 p-4 sm:p-6 rounded-2xl resize-none
     ...
     focus:ring-emerald-500 transition text-gray-800 disabled:opacity-60'
/>
...
<motion.button
 ...
 disabled={isSubmitting}
        ...
        transition font-semibold disabled:bg-grey-500' >
