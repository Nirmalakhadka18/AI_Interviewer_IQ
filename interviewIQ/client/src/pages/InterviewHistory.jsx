        ...
        const getMyInterviews = async () => {
            try {
                const result = await axios.get(
                    ServerUrl + "/api/interview/get-interview",{ withCredentials: true })
    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-emerald-50 py-10">
        <div className="w-[90vw] lg:w-[70vw] max-w-[900px] mx-auto">
            ...
            <div className="mb-10 w-full flex items-start gap-4 flex-wrap">
                ...
                <div>
                    <h1 className="text-3xl font-bold flex-nowrap
                    text-gray-800">
                        Interview History
                    </h1>
           ...
           onClick={() => navigate(`/report/${item._id}`)}
                ...
                transiton-all duration-300 cursor-pointer border
                border-gray-100">
                ...
                <p className="text-gray-500 text-sm mt-1">
                    {item.experience || "Fresher"} • {item.mode}
                </p>
